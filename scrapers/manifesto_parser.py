...
BJP_2024_INFRASTRUCTURE = [
    {
        ...
        "deadline": "2024-2027",
        "locations": [
            {"name": "Delhi-Mumbai Expressway", "lat": 26.8, "lon": 75.8, "state": "Rajasthan"},
            {"name": "Delhi-Amritsar-Katra Expressway", "lat": 31.6, "lon": 75.0, "state": "Punjab"},
            {"name": "Bengaluru-Chennai Expressway", "lat": 13.0, "lon": 79.5, "state": "Tamil Nadu"},
            {"name": "Hyderabad-Bengaluru Corridor", "lat": 15.3, "lon": 77.0, "state": "Andhra Pradesh"},
            {"name": "Ganga Expressway UP", "lat": 26.8, "lon": 81.0, "state": "Uttar Pradesh"},
        ],
    ...
    },
    {
        ...
        "deadline": "2024",
        "locations": [
            {"name": "NH-44 Expansion Kashmir to Kanyakumari", "lat": 23.0, "lon": 77.0, "state": "Multiple"},
            {"name": "NH-48 Delhi Mumbai Highway", "lat": 24.5, "lon": 73.7, "state": "Rajasthan"},
        ],
    ...
    },
    {
        ...
        "locations": [
            {"name": "Vadhavan Port Maharashtra", "lat": 19.97, "lon": 72.69, "state": "Maharashtra"},
            {"name": "Galathea Bay Port Andaman", "lat": 7.05, "lon": 93.9, "state": "Andaman"},
            {"name": "Enayam Port Tamil Nadu", "lat": 8.17, "lon": 77.32, "state": "Tamil Nadu"},
        ],
    ...
    },
    {
        ...
        "promise": "Build 100 new airports and expand existing ones under UDAN scheme",
        "ministry": "Ministry of Civil Aviation",
        "budget_promised": "₹98,000 Crore (Airport Authority)",
        "deadline": "2024-2030",
        "locations": [
            {"name": "Jewar International Airport UP", "lat": 28.01, "lon": 77.57, "state": "Uttar Pradesh"},
            {"name": "Navi Mumbai Airport", "lat": 18.99, "lon": 73.07, "state": "Maharashtra"},
            {"name": "Bhogapuram Airport AP", "lat": 18.02, "lon": 83.47, "state": "Andhra Pradesh"},
            {"name": "Hollongi Airport Arunachal", "lat": 27.1, "lon": 93.6, "state": "Arunachal Pradesh"},
        ],
    ...
    },
    {
        ...
        "deadline": "2024",
        "locations": [
            {"name": "Eastern DFC Ludhiana to Dankuni", "lat": 25.5, "lon": 84.0, "state": "Multiple"},
            {"name": "Western DFC Dadri to JNPT", "lat": 21.0, "lon": 73.0, "state": "Multiple"},
        ],
