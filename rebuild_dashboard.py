...
if img_path.exists():
    ...
    print(f"Satellite image loaded: {len(img_b64)//1024}KB")
else:
    print("WARNING: Satellite image not found")
...
SATELLITE_IMG_B64 = "SATELLITE_B64_PLACEHOLDER"
...
<head>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .green {{ color: #00ff88; }} .red {{ color: #ff3355; }} .yellow {{ color: #ffaa00; }} .blue {{ color: #3399ff; }}
...
<div class="hero">
    ...
    <div class="hero-stats">
        ...
        <div class="hero-stat"><div class="number red">{with_cases}</div><div class="label">MPs With Criminal Cases</div></div>
        <div class="hero-stat"><div class="number yellow">{above_100cr}</div><div class="label">MPs With 100Cr+ Assets</div></div>
        <div class="hero-stat"><div class="number">4.8L Cr</div><div class="label">CAG Irregularities</div></div>
    </div>
</div>

<div class="disclaimer">
    All data sourced from official ECI affidavits via MyNeta/ADR. Statistical analysis only. No accusations made.
</div>
...
<div class="container">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card"><div class="number yellow">4,82,000 Cr</div><div class="label">CAG Irregularities</div><div class="source">Source: CAG Reports 2010-2024</div></div>
        ...
        <div class="stat-card"><div class="number yellow">20,000 Cr</div><div class="label">Electoral Bonds</div><div class="source">Source: SBI Disclosure 2024</div></div>
    </div>
        ...
        <div style="background:#0d0d1a; border:1px solid #1a1a3a; border-radius:8px; padding:30px;">
            <div style="display:flex; gap:30px; flex-wrap:wrap; align-items:flex-start;">
                <div style="flex:1; min-width:280px;">
                    ...
                    <div style="color:#888; font-size:0.85em; line-height:2;">
                        <div><span style="color:#ffaa00;">PROMISE:</span> New airports operational by 2024</div>
                ...
                <div style="flex:2; min-width:300px;">
                    <img src="data:image/jpeg;base64,{SATELLITE_IMG_B64}" style="width:100%; border-radius:8px; border:1px solid #1a1a3a;" alt="Jewar Airport Satellite"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="cag">
        ...
        <div class="cag-grid">
            <div class="cag-card"><div class="cag-ministry">Ministry of Rural Development</div><div class="cag-title">MGNREGA — Wages paid for work not done. Ghost beneficiaries detected.</div><div class="cag-amount">8,243 Crore</div><div class="cag-meta"><span>CAG Report 2023</span><span class="cag-status status-ignored">NEVER DISCUSSED IN PARLIAMENT</span></div></div>
            <div class="cag-card"><div class="cag-ministry">Ministry of Defence</div><div class="cag-title">Procurement at prices above market rate. Vendors with single bids awarded.</div><div class="cag-amount">12,450 Crore</div><div class="cag-meta"><span>CAG Report 2022</span><span class="cag-status status-ignored">NEVER DISCUSSED IN PARLIAMENT</span></div></div>
            <div class="cag-card"><div class="cag-ministry">Ministry of Health</div><div class="cag-title">PM-JAY Ayushman Bharat — Fraudulent claims for deceased beneficiaries.</div><div class="cag-amount">3,122 Crore</div><div class="cag-meta"><span>CAG Report 2023</span><span class="cag-status status-ignored">NEVER DISCUSSED IN PARLIAMENT</span></div></div>
        </div>
    </div>
...
<footer>
    ...
    <p style="margin-top:10px;">
        <a href="https://github.com/govttruth/govtruth-core" style="color:#00ff88;">GitHub</a> ·
        <span style="color:#444;">govtruth.project@proton.me</span>
    </p>
    <p style="color:#333; font-size:0.75em; margin-top:15px;">Data from ECI · MyNeta · ADR · CAG · ESA Copernicus · Mapbox</p>
</footer>
...
# Replace satellite placeholder
dashboard_code = dashboard_code.replace("SATELLITE_B64_PLACEHOLDER", img_b64)
