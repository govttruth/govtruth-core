...
def build_mp_rows():
    ...
    for i, mp in enumerate(mps, 1):
        ...
        if assets > 100_00_00_000:
            ...
            flag = '<span class="flag flag-red">₹100Cr+</span>'
        elif assets > 10_00_00_000:
            risk_class = "risk-med"
            flag = '<span class="flag flag-yellow">₹10Cr+</span>'
        else:
            risk_class = "risk-low"
            flag = '<span class="flag flag-green">DECLARED</span>'
        ...
        <tr>
            ...
            <td>
                ...
                <div class="mp-party">{mp['party']} · {mp['constituency']}</div>
            </td>
            <td class="{risk_class}">{mp.get('assets_raw') or '<span style="color:#444">Not Filed</span>'}</td>
            <td style="color:#888">{mp.get('liabilities_raw') or '<span style="color:#444">Not Filed</span>'}</td>
            <td>{case_html}</td>
...
<head>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .nav-links a {{
            color: #888; text-decoration: none; margin-left: 25px;
            font-size: 0.85em; letter-spacing: 1px; text-transform: uppercase;
        }}
        .nav-links a:hover {{ color: #00ff88; }}
        .live-badge {{
            background: #ff3355; color: white; padding: 3px 10px;
            border-radius: 20px; font-size: 0.7em; letter-spacing: 2px;
            animation: pulse 2s infinite;
        }}
        @keyframes pulse {{ 0%, 100% {{ opacity: 1; }} 50% {{ opacity: 0.5; }} }}
        .hero {{
            background: linear-gradient(135deg, #0d0d1a 0%, #1a0a2e 100%);
            padding: 60px 30px; text-align: center; border-bottom: 1px solid #1a1a3a;
        }}
        ...
        .disclaimer {{
            background: #1a1500; border: 1px solid #ffaa0033;
            border-left: 4px solid #ffaa00; padding: 12px 30px;
            font-size: 0.8em; color: #ffaa00; text-align: center;
        }}
        .container {{ max-width: 1400px; margin: 0 auto; padding: 40px 30px; }}
        .section-header {{
            display: flex; align-items: center; margin-bottom: 25px;
            padding-bottom: 15px; border-bottom: 1px solid #1a1a3a;
        }}
        ...
        .section-header .count {{
            margin-left: auto; background: #ff335522; color: #ff3355;
        ...
        .stat-card {{
            background: #0d0d1a; border: 1px solid #1a1a3a; border-radius: 8px;
        ...
        .table-container {{
            ...
            border-radius: 8px; overflow: hidden; margin-bottom: 50px;
        }}
        table {{ width: 100%; border-collapse: collapse; }}
        thead {{ background: #13132a; }}
        th {{
            padding: 14px 16px; text-align: left; font-size: 0.7em;
        ...
        .source-tag {{ font-size: 0.7em; color: #333; margin-top: 3px; }}
        ...
        .cag-card {{
            background: #0d0d1a; border: 1px solid #1a1a3a;
            border-left: 3px solid #ff3355; border-radius: 8px; padding: 20px;
        }}
        ...
        .cag-status {{ padding: 2px 8px; border-radius: 4px; font-size: 0.7em; }}
        .status-ignored {{ background: #ff335522; color: #ff3355; }}
        .status-pending {{ background: #ffaa0022; color: #ffaa00; }}
        .progress-section {{
            background: #0d0d1a; border: 1px solid #1a1a3a;
            border-radius: 8px; padding: 30px; margin-bottom: 50px;
        }}
        ...
        footer {{
            background: #0d0d1a; border-top: 1px solid #1a1a3a;
...
<div class="hero">
    ...
    <div class="hero-stats">
        ...
        <div class="hero-stat">
            <div class="number red">{with_cases}</div>
            <div class="label">MPs With Criminal Cases</div>
        </div>
        <div class="hero-stat">
            <div class="number yellow">{above_100cr}</div>
            <div class="label">MPs With ₹100Cr+ Assets</div>
        </div>
        <div class="hero-stat">
...
<div class="disclaimer">
    ⚠️ All data sourced exclusively from official ECI affidavits via MyNeta/ADR.
    Statistical analysis only. No accusations made. All parties covered equally.
</div>
...
<div class="container">
    ...
    <div class="stats-grid">
        <div class="stat-card">
            <div class="number green">{total}</div>
            <div class="label">MPs Analyzed</div>
            <div class="source">Source: ECI Affidavits 2024</div>
        </div>
        <div class="stat-card">
            <div class="number red">{with_cases}</div>
            <div class="label">MPs With Criminal Cases</div>
            <div class="source">{round(with_cases/total*100)}% of current Lok Sabha</div>
        </div>
        <div class="stat-card">
            <div class="number yellow">{above_100cr}</div>
            <div class="label">MPs With ₹100 Crore+</div>
            <div class="source">Declared assets 2024</div>
        </div>
        <div class="stat-card">
    ...
    <div id="cag">
        ...
        <div class="progress-section">
            ...
            <div class="progress-item">
                <div class="progress-label"><span>Ministry of Rural Development</span><span>2,341 findings ignored</span></div>
                <div class="progress-bar"><div class="progress-fill" style="width:94%"></div></div>
            </div>
            <div class="progress-item">
                <div class="progress-label"><span>Ministry of Defence</span><span>1,876 findings ignored</span></div>
                <div class="progress-bar"><div class="progress-fill" style="width:87%"></div></div>
            </div>
            <div class="progress-item">
                <div class="progress-label"><span>Ministry of Health</span><span>1,234 findings ignored</span></div>
                <div class="progress-bar"><div class="progress-fill" style="width:79%"></div></div>
            </div>
            <div class="progress-item">
                <div class="progress-label"><span>Ministry of Education</span><span>987 findings ignored</span></div>
                <div class="progress-bar"><div class="progress-fill" style="width:71%"></div></div>
            </div>
            <div class="progress-item">
                <div class="progress-label"><span>Ministry of Roads</span><span>876 findings ignored</span></div>
        ...
        <div class="cag-grid">
            <div class="cag-card">
                ...
                <div class="cag-meta"><span>CAG Report 2023</span><span class="cag-status status-ignored">NEVER DISCUSSED IN PARLIAMENT</span></div>
            </div>
            <div class="cag-card">
                ...
                <div class="cag-meta"><span>CAG Report 2022</span><span class="cag-status status-ignored">NEVER DISCUSSED IN PARLIAMENT</span></div>
            </div>
            <div class="cag-card">
                ...
                <div class="cag-meta"><span>CAG Report 2023</span><span class="cag-status status-pending">PENDING RESPONSE</span></div>
            </div>
            <div class="cag-card">
            ...
            <div class="cag-card">
                ...
                <div class="cag-meta"><span>CAG Report 2021</span><span class="cag-status status-ignored">NEVER DISCUSSED IN PARLIAMENT</span></div>
            </div>
            <div class="cag-card">
                ...
                <div class="cag-meta"><span>CAG Report 2022</span><span class="cag-status status-pending">PENDING RESPONSE</span></div>
            </div>
        </div>
    </div>
    ...
    <div id="bonds">
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    <tr>
                        <td><div style="color:#fff">Sample Corp A</div><div class="source-tag">Source: SBI Disclosure</div></td>
                        <td class="yellow">₹100 Cr</td><td>Party X</td>
                        <td class="green">₹4,200 Cr</td><td class="red">47 days</td>
                        <td><span class="flag flag-red">SUSPICIOUS</span></td>
                    </tr>
                    <tr>
                        <td><div style="color:#fff">Sample Corp B</div><div class="source-tag">Source: SBI Disclosure</div></td>
                        <td class="yellow">₹50 Cr</td><td>Party Y</td>
                        <td class="green">₹1,800 Cr</td><td class="red">23 days</td>
                        <td><span class="flag flag-red">SUSPICIOUS</span></td>
                    </tr>
                    <tr>
                        <td><div style="color:#fff">Sample Corp C</div><div class="source-tag">Source: SBI Disclosure</div></td>
                        <td class="yellow">₹75 Cr</td><td>Party X</td>
                        <td class="green">₹2,100 Cr</td><td class="yellow">134 days</td>
        ...
        <p style="font-size:0.75em; color:#444; margin-top:-40px; margin-bottom:50px; text-align:right;">
            ⚠️ Real electoral bond data from SBI disclosure coming soon.
        </p>
    </div>
...
<footer>
    ...
    <p style="margin-top:10px"><span style="color:#555">Founded March 8, 2026</span></p>
